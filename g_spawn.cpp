...
static void G_InitStatusbar()
{
	...
	// Kyper - Lithium port - display help text for binding hook / accessing help info
	...
	// safety
	sb.ifstat(STAT_LITHM_SAFETY).xl(155).yb(-17).stat_string(STAT_LITHM_SAFETY).endifstat();
	// Kyper
